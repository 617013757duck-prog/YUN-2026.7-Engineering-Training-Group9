...
-- 插入测试医疗人员账号（密码：doctor123）
INSERT INTO users (username, password, real_name, role, status) VALUES
('doctor', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EH', '测试医生', 'MEDICAL_STAFF', 1)
ON DUPLICATE KEY UPDATE username='doctor';

-- 插入测试随访人员账号（密码：followup123）
INSERT INTO users (username, password, real_name, role, status) VALUES
('followup', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EH', '测试随访员', 'FOLLOWUP_STAFF', 1)
ON DUPLICATE KEY UPDATE username='followup';
